...
(e=>{const n=document.createElement("style");n.dataset.source="vite-plugin-monkey",n.innerText=e,document.head.appendChild(n)})(`@charset "UTF-8";
.tablead,
.creator-item,
.vip-entry,
.special-activity,
...
(function() {
  ...
  function detectPage() {
    ...
    if (url.pathname === "/post")
      ...
      const type = (_a = url.searchParams.get("type")) != null ? _a : "0";
      if (type === "12")
        page = "search-course";
      else
        page = "search";
  ...
  (() => {
    console.log(`[Juejin Plus] v${"1.0.0"}`);
    detectPage();
